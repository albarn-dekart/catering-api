    ...
    public function load(ObjectManager $manager): void
    {
        $restaurants = [
            [
                ...
                'couriers' => [UserFixtures::COURIER_1, UserFixtures::COURIER_2],
                'image' => 'bella.webp',
                'delivery_price' => 1500,
            ...
            [
                ...
                'couriers' => [UserFixtures::COURIER_3],
                'image' => 'azjatyk.webp',
                'delivery_price' => 1200,
            ...
            [
                ...
                'couriers' => [UserFixtures::COURIER_4, UserFixtures::COURIER_5],
            ...
            [
                ...
                'couriers' => [UserFixtures::COURIER_6, UserFixtures::COURIER_7],
            ...
            [
                ...
                'couriers' => [UserFixtures::COURIER_8],
            ...
            [
                ...
                'couriers' => [UserFixtures::COURIER_9, UserFixtures::COURIER_10],
        ...
        foreach ($restaurants as $data) {
            ...
            // Assign couriers to restaurant
            foreach ($data['couriers'] as $courierRef) {
                /** @var User|null $courier */
                $courier = $this->getReference($courierRef, User::class);
                $restaurant->addCourier($courier);
            }
