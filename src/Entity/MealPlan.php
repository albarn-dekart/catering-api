...
#[ApiResource(
    ...
    graphQlOperations: [
        ...
        new Mutation(
            security: "(is_granted('ROLE_RESTAURANT') and object.getRestaurant().getOwner() == user) or is_granted('ROLE_CUSTOMER')",
            securityPostDenormalize: "(is_granted('ROLE_RESTAURANT') and object.getRestaurant().getOwner() == user) or (is_granted('ROLE_CUSTOMER') and object.getOwner() == user)",
            name: 'create'
        ),
        new Mutation(security: "(is_granted('ROLE_RESTAURANT') and object.getRestaurant().getOwner() == user) or (is_granted('ROLE_CUSTOMER') and object.getOwner() == user)", name: 'update'),
        new DeleteMutation(security: "(is_granted('ROLE_RESTAURANT') and object.getRestaurant().getOwner() == user) or (is_granted('ROLE_CUSTOMER') and object.getOwner() == user)", name: 'delete')
    ],
)]
