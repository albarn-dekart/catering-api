...
#[ApiResource(
    ...
    graphQlOperations: [
        ...
        new Mutation(security: "(is_granted('ROLE_RESTAURANT') and object.getRestaurant().getOwner() == user)", name: 'create'),
        new Mutation(security: "(is_granted('ROLE_RESTAURANT') and object.getRestaurant().getOwner() == user)", name: 'update'),
