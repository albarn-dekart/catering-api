 ...
 */
class getRecipientDetailsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecipientDetailsRepository' shared autowired service.
     *
     * @return \App\Repository\RecipientDetailsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecipientDetailsRepository.php';

        return $container->privates['App\\Repository\\RecipientDetailsRepository'] = new \App\Repository\RecipientDetailsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
